...
const BUBBLES = [
  { x: 9, y: 274, w: 250, h: 70, emoji: '😪', ex: 24, ey: 292, text: 'The conversations you half-remember', tx: 59, ty: 285, tw: 192 },
  { x: 201, y: 350, w: 228, h: 64, emoji: '😡', ex: 220, ey: 366, text: 'Mood swings you can’t control', tx: 256, ty: 357, tw: 165 },
  { x: 214, y: 565, w: 219, h: 70, emoji: '🥱', ex: 228, ey: 583, text: 'Waking up in an unfamiliar place', tx: 262, ty: 576, tw: 168 },
  { x: 5, y: 644, w: 331, h: 70, emoji: '🚷', ex: 20, ey: 662, text: 'The plans you cancelled because you were hungover', tx: 55, ty: 655, tw: 278 },
]
    ...
    <div className="fig" style={{ background: ORANGE }}>
      ...
      {BUBBLES.map((b) => (
        <div key={b.text}>
          ...
          <p className="abs" style={{ left: b.tx, top: b.ty, width: b.tw, fontSize: 22, lineHeight: '24px', color: '#fff' }}>
            {b.text}
          </p>
        </div>
      ))}
