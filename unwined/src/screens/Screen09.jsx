...
// Figma 153:715 "9" — Question E: who do you usually drink with (multi-select).
const OPTIONS = [
  { slug: 'alone', label: 'Alone', top: 298, row: 29, cb: 50, lx: 84 },
  { slug: 'partner-or-spouse', label: 'Partner or spouse', top: 376, row: 29, cb: 50, lx: 84 },
  { slug: 'close-friends', label: 'Close friends', top: 454, row: 29, cb: 50, lx: 83 },
  { slug: 'coworkers-peers', label: 'Coworkers / peers', top: 532, row: 29, cb: 49, lx: 83 },
  { slug: 'whoevers-around-at-the-time', label: 'Whoever’s around at the time', top: 610, row: 30, cb: 50, lx: 84 },
  { slug: 'other', label: 'Other', top: 688, row: 30, cb: 50, lx: 84 },
]
...
export default function Screen09({ next, back, setAnswer }) {
  ...
  return (
    <div className="fig">
      ...
      <p className="abs" style={{ left: 31, top: 242, width: 325, fontSize: 18, lineHeight: '35px', color: 'rgba(255,255,255,0.5)' }}>
