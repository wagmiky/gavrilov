...
// Figma 212:1065 "27-2" — "Your mindful days streak, tracked." Same layout
// as 27-1 with month-based copy.
const DAYS = [
  ['Mon', 47, 'check'],
  ['Tue', 99, 'check'],
  ['Wed', 151, 'check'],
...
export default function Screen27Mindful({ next }) {
  return (
    <div className="fig side">
      <StatusBar />
      <Logo />
      <img src={ringOuter} alt="" className="abs" style={{ left: 75, top: 186, width: 290, height: 291 }} />
      <img src={speckles} alt="" className="abs" style={{ left: 84.3, top: 194.5, width: 271.8, height: 272.4 }} />
      <p className="abs serif" style={{ left: 139, top: 248, width: 164, fontSize: 52, lineHeight: '52px', textAlign: 'center', color: '#fff' }}>
        23 / 28 days
      </p>
      <p className="abs" style={{ left: 129, top: 361, width: 190, fontSize: 22, textAlign: 'center', color: '#fff' }}>
        Alcohol-free in the past month.
      </p>
      <p className="abs" style={{ left: 115, top: 483, width: 205, fontSize: 26, textAlign: 'center', color: '#fff' }}>
        Journey started
      </p>
      <p className="abs serif" style={{ left: 115, top: 514, width: 205, fontSize: 26, textAlign: 'center', color: '#fff' }}>
        01/22/26
      </p>

      <p className="abs" style={{ left: 33, top: 609, width: 337, fontSize: 32, color: '#fff' }}>
        Your mindful days streak, tracked.
      </p>
